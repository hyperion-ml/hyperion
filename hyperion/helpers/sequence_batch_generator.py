...
from ..io import RandomDataReaderFactor as RF
...
class SequenceBatchGenerator(object):
    ...
    def __init__(self, rspecifier, key_file, batch_size=1,
                 num_iters_per_epoch=1,
                 epoch=0,
                 mode='random_slice', 
                 min_seq_length=1, max_seq_length=None,
                 seq_overlap=0,
                 prune_short_seqs=False,
                 shuffle_seqs=True,
                 transform=None, splicing=None,
                 seqr_seed=1024, reset_rng=False,
                 scp_sep=' ', 
                 part_idx=1, num_parts=1):
        
        self.r = RF.create(data_file)
