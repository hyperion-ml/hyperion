...
class MultiTestTrialDataReaderV2(object):
    ...
    def __init__(self, enroll_v_file, test_v_file, ndx_file, enroll_file, test_file, 
    ...
    def add_argparse_args(parser, prefix=None):
        ...
        parser.add_argument(p1+'num-model-parts', default=1, type=int,
        ...
        parser.add_argument(p1+'num-seg-parts', default=1, type=int,
                            help=('number of parts in which we divide the test list '
                                  'to run evaluation in parallel'))
        
        parser.add_argument(p1+'eval-set', type=str.lower,
                            default='enroll-test',
