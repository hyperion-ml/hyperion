...
def train_xvector(data_path, train_list, val_list,
                  encoder_net, classif_net, preproc_net, loss,
                  exp_path, epochs, resume, resume_path, num_gpus, seed, **kwargs):
    ...
    trainer = XVectorTrainer(model, optimizer, loss, epochs, exp_path, device=device, metrics=metrics, lr_scheduler=lr_sch)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num-gpus', action='num_gpus', default=1,
                        help='number of gpus, if 0 use cpu')
