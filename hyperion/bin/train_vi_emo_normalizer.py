...
def init_vc_model(
    ...
    Args:
        rank: Process rank in distributed training.
        model_class: VI emotion normalizer/VC model class to instantiate.
...
def train_model(gpu_id: int, args: Any) -> None:
    """Run distributed training for VI emotion normalizer model.
...
def make_parser(model_class: Type[HyperTorchModel]) -> ArgumentParser:
    """Create parser for one VI emotion normalizer model subcommand.
