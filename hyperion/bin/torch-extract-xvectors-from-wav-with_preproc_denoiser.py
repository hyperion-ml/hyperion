...
def extract_xvectors_with_preproc_denoiser(input_spec, output_spec, vad_spec, write_num_frames_spec,
                     ...
                     use_gpu, denoiser_model_path, denoiser_model_load_string , 
                     denoiser_model_n_layers , **kwargs):
    ...
    preproc_denoiser = Preprocessor_Denoiser(denoiser_model_path, denoiser_model_load_string , denoiser_model_n_layers , device).to(device)
...
if __name__ == "__main__":
    ...
    parser=ArgumentParser(
        description=('Extracts x-vectors from waveform computing using denoiser as pre-processor'
