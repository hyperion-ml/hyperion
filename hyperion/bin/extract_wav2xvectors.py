...
def main() -> None:
    ...
    parser.add_argument(
        "--dataset-path",
        default=None,
        help="HyperDataset manifest describing recordings and optional VAD entries",
    )
    parser.add_argument(
        "--recordings-file",
        default=None,
    ...
    parser.add_argument(
        "--vad", dest="vad_spec", default=None, help="(Deprecated) VAD specifier"
    )
    parser.add_argument(
        "--vad-file",
        default=None,
    ...
    parser.add_argument(
        "--vad-name",
        default=None,
        help="Name of VAD entry stored in the dataset to use for inference",
    )
    parser.add_argument(
        "--write-speech-dur",
        default=None,
    ...
    if args.dataset_path is not None and args.segments_file is not None:
        parser.error("--segments-file is incompatible with --dataset-path")
