...
from hyperion.keras1.keras_utils import *
from hyperion.keras1.vae import TiedVAE_qYqZgY as TVAEYZ
from hyperion.keras1.vae import TiedVAE_qY as TVAEY
...
def train_pdda(iv_file, train_utt2spk, val_utt2spk,
    ...
    h = vae.fit_generator(x_train, x_val=x_val,
