...
def eval_xvec(input_spec, output_spec, vad_spec, write_num_frames_spec,
              scp_sep, vad_path_prefix, 
              model_path, chunk_length, 
...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(
        description=('Evaluates x-vectors logits from waveform computing '
