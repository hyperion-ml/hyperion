...
from ..narchs import SpineNetFactory as RNF


class SpineNetXVector(XVector):

    def __init__(self, spinenet_type,
                 in_feats, num_classes, in_channels,
                 output_levels=[3, 4, 5, 6, 7], endpoints_num_filters=256, resample_alpha=0.5,
                 block_repeats=1, filter_size_scale=1.0,
        ...
        encoder_net = RNF.create(
            spinenet_type, in_channels, output_levels=output_levels, endpoints_num_filters=endpoints_num_filters,
        ...
        super().__init__(
            ...
            in_feats=in_feats, proj_feats=proj_feats)
    ...
    def get_config(self):
        ...
        config = {'spinenet_type': self.spinenet_type,
