...
class OptimizerFactory(object):
    ...
    def create(params, opt_type, lr, momentum=0,
        ...
        if oss: # (JJ: EXP - this (oss=True) is NOT touched for dinossl_style param filtering so with dinossl_style, the behavior is not yet confirmed)
    ...
    def filter_args(**kwargs):
        valid_args = ('opt_type', 'lr', 'momentum', 'beta1', 'beta2',
                      ...
                      'centered','lr_decay','init_acc_val','max_iter', 'oss', 'dinossl_style')
