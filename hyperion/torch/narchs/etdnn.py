...
class ETDNNV1(NetArch):
    """Extended TDNN encoder with optional output projection.

    Attributes:
        num_blocks: Number of ETDNN blocks.
    ...
    def __init__(
        ...
        Args:
            ...
            dropout_rate: Dropout probability used in the ETDNN blocks.
