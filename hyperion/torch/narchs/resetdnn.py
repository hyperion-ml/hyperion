...
class ResETDNNV1(NetArch):
    """Residual Extended TDNN encoder with optional output projection.

    Attributes:
        num_blocks: Number of blocks in the encoder.
        ...
        hid_units: Hidden layer width specification for the residual stack.
        expand_units: Output width of the final non-residual block.
    ...
    def __init__(
        ...
        """Initializes the residual ETDNN encoder.

        Args:
            num_blocks: Number of blocks in the encoder.
            in_units: Input feature dimension.
            hid_units: Hidden width used by the residual blocks.
            expand_units: Width of the final non-residual block.
            ...
            dropout_rate: Dropout probability used in the blocks.
