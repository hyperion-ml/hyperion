...
class ResNet1dXVector(XVector):
    """x-vector model that wraps a 1D ResNet encoder.
    ...
    Attributes:
        ...
        resnet_enc: Saved encoder configuration when serialized.
    """

    def __init__(
        self,
        resnet_enc: Union[Dict[str, Any], nn.Module],
        num_classes: int,
        ...
        """Build a 1D ResNet x-vector model.

        Args:
            resnet_enc: Encoder module or configuration dictionary.
    ...
    def change_config(
        ...
        Args:
            resnet_enc: New encoder configuration.
