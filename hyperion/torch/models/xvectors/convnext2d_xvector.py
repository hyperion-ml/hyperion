...
from ...narchs import ConvNext2dEncoder as Encoder
from .xvector import XVector


class ConvNext2dXVector(XVector):
    """x-vector model that wraps a 2D ConvNeXt encoder.
    ...
    def __init__(
        ...
        """Build a 2D ConvNeXt x-vector model.

        Args:
            convnext_enc: Encoder module or configuration dictionary.
            in_feats: Input feature dimension for the 2D encoder.
    ...
    def add_class_args(parser: Any, prefix: Optional[str] = None) -> None:
        ...
        XVector.add_class_args(parser, skip=set())
