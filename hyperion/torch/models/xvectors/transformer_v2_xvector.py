...
class TransformerV2XVector(XVector):
    """x-vector model that wraps a Transformer V2 encoder.
    ...
    Attributes:
        ...
        transformer_enc: Saved encoder configuration when serialized.
    """

    def __init__(
        self,
        transformer_enc: Union[Dict[str, Any], nn.Module],
        num_classes: int,
        ...
        """Build a Transformer V2 x-vector model.

        Args:
            transformer_enc: Encoder module or configuration dictionary.
    ...
    def change_config(
        ...
        Args:
            transformer_enc: New encoder configuration.
    ...
    def _pre_enc(self, x: torch.Tensor) -> torch.Tensor:
        """Transpose inputs into the encoder layout.
    ...
    def _post_enc(
        ...
        """Transpose encoder outputs back to x-vector layout.
