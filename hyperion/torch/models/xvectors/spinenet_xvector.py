...
class SpineNetXVector(XVector):
    """x-vector model that wraps a SpineNet encoder.
    ...
    Attributes:
        ...
        spinenet_type: Encoder factory key used to build the model.
    """
    ...
    def __init__(
        ...
        """Build a SpineNet x-vector model.

        Args:
            spinenet_type: SpineNet factory key.
            in_feats: Input feature dimension.
            num_classes: Number of output classes.
            in_channels: Number of input channels for the encoder.
            output_levels: Encoder output levels to use.
            endpoints_num_filters: Number of filters in endpoint blocks.
            resample_alpha: Resampling interpolation factor.
            block_repeats: Number of repeats per block.
            filter_size_scale: Filter size scale factor.
    ...
    def output_levels(self):
        """Return the configured output levels.
    ...
    def endpoints_num_filters(self):
        """Return the endpoint filter count.

        Returns:
            Endpoint filter count.
        """
        return self.encoder_net.endpoints_num_filters

    @property
    def resample_alpha(self):
        """Return the resampling alpha.
    ...
    def block_repeats(self):
        """Return the block repeat schedule.

        Returns:
            Block repeat schedule.
        """
        return self.encoder_net.block_repeats

    @property
    def filter_size_scale(self):
        """Return the filter size scale.
