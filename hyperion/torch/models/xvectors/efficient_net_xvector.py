...
class EfficientNetXVector(XVector):
    ...
    def __init__(self, effnet_type, in_feats, num_classes, 
        ...
        encoder_net = EN(
            effnet_type, in_channels, in_conv_channels, in_kernel_size, in_stride,
            mbconv_repeats, mbconv_channels, mbconv_kernel_sizes, mbconv_strides,
