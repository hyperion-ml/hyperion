...
class HFWav2Vec2ConformerV1RNNTransducer(HFWav2RNNTransducer):
    """RNN-T wrapper with Wav2Vec2 front-end and Conformer backend.
    ...
    def filter_args(**kwargs: Any) -> Dict[str, Any]:
        ...
        child_args = ConformerV1RNNTransducer.filter_args(**kwargs["transducer"])
    ...
    def add_class_args(parser: Any, prefix: Optional[str] = None) -> None:
        ...
        ConformerV1RNNTransducer.add_class_args(
            parser, prefix="transducer", skip={"in_feats"}
        )
