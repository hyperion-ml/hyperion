...
class HFWav2Vec2Bert2ResNet1dXVector(HFWav2XVector):
    """Wrapper that combines Wav2Vec2-BERT features with a ResNet1d x-vector backend.
    ...
    def filter_args(**kwargs: Any) -> Dict[str, Any]:
        ...
        base_args["xvector"] = ResNet1dXVector.filter_args(**kwargs["xvector"])
        return base_args
