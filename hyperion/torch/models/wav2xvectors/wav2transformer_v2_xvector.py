...
class Wav2TransformerV2XVector(Wav2XVector):
    ...
    def add_class_args(parser, prefix=None):
        """Adds Wav2TransformerV2XVector options to parser.
