...
class Conformer(Transformer):
    ...
    def add_class_args(
        ...
        parser.add_argument("--num-features", default=80, type=int, help=(""))

        parser.add_argument("--subsampling-factor", default=4, type=int, help=(""))

        parser.add_argument("--d-model", default=512, type=int, help=(""))

        parser.add_argument("--nhead", default=8, type=int, help=(""))

        parser.add_argument("--dim-feedforward", default=2048, type=int, help=(""))

        parser.add_argument("--num-encoder-layers", default=12, type=int, help=(""))

        parser.add_argument("--vgg-frontend", default=False, type=bool, help=(""))
        if prefix is not None:
