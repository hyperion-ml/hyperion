...
def _subpixel_conv1(in_channels, out_channels, stride=1, bias=False):
    ...
    return SubPixelConv1d(in_channels, out_channels, kernel_size=1, stride=stride, bias=bias)


def _subpixel_convk(in_channels, out_channels, kernel_size=3, stride=1, groups=1, dilation=1, bias=False):
...
class ResNet1dBasicBlock(nn.Module):
    ...
    def __init__(self, in_channels, channels, kernel_size=3,
        ...
        self.conv1 = _convk(in_channels, channels, kernel_size, stride, groups, dilation, bias=bias)
...
class ResNet1dBasicDecBlock(nn.Module):
    ...
    def __init__(self, in_channels, channels, kernel_size=3,
        ...
        bias = not norm_before
        self.conv1 = _subpixel_convk(in_channels, channels, kernel_size, stride, groups, dilation, bias=bias)
...
class ResNet1dBNDecBlock(nn.Module):
    ...
    def __init__(self, in_channels, channels, kernel_size=3,
        ...
        bias = not norm_before
        self.conv1 = _conv1(in_channels, bn_channels, stride=1, bias=bias)
        self.conv2 = _subpixel_convk(bn_channels, bn_channels, kernel_size, 
