...
class ARTSPhase1Eval3BritishDataPrep(DataPrep):
    """
    Prepares the ARTS Phase I Eval3 British Initialization Sample dataset.
    ...
    def __init__(
        ...
        self.corpus_dir = (
            self.corpus_dir / "ARTS_Phase1_Eval3_British_Initialization_Dataset_V1.0"
        )

    @staticmethod
    def dataset_name() -> str:
        """Returns the dataset name identifier."""
        return "arts_phase1_eval3_british"

    @staticmethod
    def add_class_args(parser) -> None:
        """Adds command-line arguments specific to the ARTSPhase1Eval3BritishDataPrep data preparation."""
    ...
    def _read_docs(self) -> pd.DataFrame:
        ...
        seg_file = docs_dir / "phase1-3_British_ta1_initmeta.csv"
        ...
        df_segs["ta2_dialect"] = "SSBE"
        df_segs["native_language"] = "eng"
