...
def get_keras_custom_obj():
    custom_obj = {
        ...
        'GlobalProdRenormDiagNormalCommonVarStdPrior': GlobalProdRenormDiagNormalCommonVarStdPrior,
        'GlobalProdRenormDiagNormalConstVarStdPrior': GlobalProdRenormDiagNormalConstVarStdPrior,
        'GlobalProdRenormDiagNormalConstVarStdPrior2': GlobalProdRenormDiagNormalConstVarStdPrior2,
        'GlobalProdRenormDiagNormalConstVarStdPrior3': GlobalProdRenormDiagNormalConstVarStdPrior3,
        'GlobalProdRenormDiagNormalConstVarStdPrior4': GlobalProdRenormDiagNormalConstVarStdPrior4,
        'GlobalProdRenormNormalConstCovStdPrior': GlobalProdRenormNormalConstCovStdPrior,
        'MultConstDiagVar': MultConstDiagVar,
        'MultConstDiagVarStdPrior': MultConstDiagVarStdPrior,
