...
class PCA(HypModel):
    ...
    def add_class_args(parser, prefix=None):
        ...
        parser.add_argument(p1 + 'update-mu',
                            default=True,
                            type=bool,
                            help=('updates centering parameter'))
        parser.add_argument(p1 + 'update-T',
                            default=True,
                            type=bool,
                            help=('updates whitening parameter'))

        parser.add_argument(p1 + 'pca-dim',
                            default=None,
                            type=int,
        ...
        parser.add_argument(
            ...
            type=int,
            help=(
                'proportion of variance to keep when choosing the PCA dimension'
            ))
