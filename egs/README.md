...
| | v2.1 | Adversarial Attacks and Baseline Defenses on x-Vector Speaker Verification with x-vector training is done using on-the-fly feature extaction |
...
| | v2.1 | SRE19-CTS Tunisian Arabic using PyTorch x-Vectors with on-the-fly feat extraction and speech augmentation |
| ------- | ------- | ---- |
