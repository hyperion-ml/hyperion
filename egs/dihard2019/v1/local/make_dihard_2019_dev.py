...
# This script is called by local/make_dihard_2_dev.sh, and it creates the
# necessary files for DIHARD 2 development directory.

import sys, os

def prepare_dihard2019_dev(src_dir, data_dir):
...
def main():
    ...
    prepare_dihard2019_dev(src_dir, data_dir)
    return 0
