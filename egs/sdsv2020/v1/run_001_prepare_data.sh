...
if [ $stage -le 1 ];then
    ...
    utils/combine_data.sh data/voxcelebcat data/voxceleb1cat_train data/voxceleb2cat_train data/voxceleb2cat_test 
fi

if [ $stage -le 2 ];then
    # prepare task1
    local/make_sdsv2020_task1.sh $sdsv_root/task1 data
fi

if [ $stage -le 3 ];then
    # prepare task1
    local/make_sdsv2020_task2.sh $sdsv_root/task2 data
fi
