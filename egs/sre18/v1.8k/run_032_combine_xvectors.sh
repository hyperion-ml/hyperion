...
if [ $stage -le 1 ]; then
    ...
    utils/combine_data.sh data/sitw_dev_${diar_name} data/sitw_dev_train data/sitw_dev_test_${diar_name}
    mkdir -p $xvector_dir/sitw_dev_train_${diar_name}
    cat $xvector_dir/sitw_{dev_train,dev_test_${diar_name}}/xvector.scp > $xvector_dir/sitw_dev_${diar_name}/xvector.scp
