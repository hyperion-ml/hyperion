...
if [ $stage -le 1 ];then
  ...
  # the list.
  for name in swbd_sre_tel_aug_180k sre_phnmic_aug_20k voxceleb_aug_250k 
  do
...
if [ $stage -le 2 ];then
    ...
    utils/combine_data.sh data/swbd_sre_tel_combined data/swbd_sre_tel_aug_180k data/swbd_sre_tel
