...
master_key=$master_key_dir/NIST_SRE_segments_key.csv
...
if [ $stage -le 1 ]; then
  ...
  local/make_sre04-06.sh $ldc_root $master_key data

  # Prepare sre08
  local/make_sre08.sh $data_root/LDC2011S08 $data_root/LDC2011S05 $master_key data/
  ...
  local/make_sre10.sh /export/corpora5/SRE/SRE2010/eval $master_key data/
