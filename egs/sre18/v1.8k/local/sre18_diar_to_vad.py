...
if __name__ == "__main__":
    ...
    utt2num_frames = pd.read_csv(args.num_frames_file, sep=' ', header=None, names=['utt','num_frames', 'None'], index_col=0)
    diar = pd.read_csv(args.diar_file, sep=' ', header=None, names=['utt', 'start','end'], index_col=0)
