...
utils/combine_data.sh --extra-files "utt2clean" $out_dir/mx6_mic_04_to_13 $out_dir/mx6_mic_{04,05,06,07,08,09,10,11,12,13}
...
hyp_utils/subset_data_dir.sh --extra-files "utt2clean" $out_dir/mx6_mic_04_to_13 2000 $out_dir/mx6_mic_04_to_13_2k
utils/combine_data.sh --extra-files "utt2clean" $out_dir/mx6_mic $out_dir/mx6_mic_02 $out_dir/mx6_mic_04_to_13_2k
...
utils/combine_data.sh --extra-files "utt2clean" $out_dir/mx6 $out_dir/mx6_mic $out_dir/mx6_calls
utils/fix_data_dir.sh --utt-extra-files "utt2clean" $out_dir/mx6
