...
nnet_s1_base_cfg=conf/train_${feat_type}_idrnd_resnet100_xvec_stage1_v3.1.yaml
nnet_s1_name=$nnet_name.s1
nnet_s1_dir=exp/xvector_nnets/$nnet_s1_name
nnet_s1=$nnet_s1_dir/model_ep0069.pth

nnet_s2_base_cfg=conf/train_fbank64_stmn_nb_fwseres2net50w26s8_xvec_stage2_v3.2.yaml
nnet_name=${feat_type}_idrnd_resnet100.v3.1
