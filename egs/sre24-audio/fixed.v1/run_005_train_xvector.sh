...
train_data_dir=data/${nnet_data}_train
val_data_dir=data/${nnet_data}_val
...
#     hyp_utils/conda_env.sh --conda-env $HYP_ENV --num-gpus $ngpu \
#     hyperion-finetune-wav2xvector-domain-adv $nnet_type --cfg $nnet_s3_base_cfg $nnet_s3_args $extra_args \
#     --data.train.dataset.recordings-file $train_data_dir/recordings.csv \
#     --data.train.dataset.segments-file $train_data_dir/segments.csv \
#     --data.train.dataset.class-files $train_data_dir/speaker.csv $train_data_dir/source_type.csv $train_data_dir/language.csv \
#     --data.val.dataset.recordings-file $val_data_dir/recordings.csv \
#     --data.val.dataset.segments-file $val_data_dir/segments.csv \
