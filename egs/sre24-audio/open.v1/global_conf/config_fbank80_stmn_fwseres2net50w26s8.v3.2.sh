...
nnet_s1_base_cfg=conf/train_fwseres2net50w26s8_xvec_stage1_v3.2.yaml
nnet_s1_name=$nnet_name.s1
nnet_s1_dir=exp/xvector_nnets/$nnet_s1_name
nnet_s1=$nnet_s1_dir/model_ep0141.pth

nnet_s2_base_cfg=conf/train_fwseres2net50w26s8_xvec_stage2_v3.2.yaml
nnet_name=${feat_type}_fwseres2net50w26s8.v3.2
...
# be_sre24_cfg=conf/plda_adapt_sre24_fixed.yaml
# be_sre24_name=plda_adapt_sre24_fixed
