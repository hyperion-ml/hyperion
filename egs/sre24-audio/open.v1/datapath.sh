...
if [ "$(hostname --y)" == "clsp" ];then
  ...
  # sre19_cts_root=$ldc_root3/LDC2019E58
  # sre19_av_dev_root=$ldc_root/LDC2019E56
  # sre19_av_eval_root=$ldc_root/LDC2019E57
  sre19_cts_root=$ldc_root7/LDC2023S03
  sre19_av_dev_root=$ldc_root7/LDC2023V01
  sre19_av_eval_root=$ldc_root7/LDC2023V01
  voxceleb1_root=/export/corpora5/VoxCeleb1_v2
  voxceleb2_root=/export/corpora5/VoxCeleb2
  ...
  #sre19_cts_root=$ldc_root/LDC2019E58
  sre19_cts_root=$ldc_root/LDC2023S03
  sre19_av_dev_root=$ldc_root/LDC2023V01
  sre19_av_eval_root=$ldc_root/LDC2023V01
  # sre19_av_dev_root=$sre_root/SRE19/LDC2019E56
  # sre19_av_eval_root=$sre_root/SRE19/LDC2019E57
