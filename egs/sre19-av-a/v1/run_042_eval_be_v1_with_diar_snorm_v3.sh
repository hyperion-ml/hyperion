...
coh_vid_data=dihard2_sitw_sre18_dev_vast_${diar_name}
coh_vast_data=dihard2_sitw_sre18_dev_vast_${diar_name}
...
if [ ! -d data/$coh_vid_data ];then
    utils/combine_data.sh data/$coh_vid_data data/dihard2_train data/sitw_sre18_dev_vast_${diar_name}
fi
if [ ! -f $xvector_dir/$coh_vid_data/xvector.scp ];then
    mkdir -p $xvector_dir/$coh_vid_data
    cat $xvector_dir/dihard2_train/xvector.scp $xvector_dir/sitw_sre18_dev_vast_${diar_name}/xvector.scp  > $xvector_dir/$coh_vid_data/xvector.scp
fi
