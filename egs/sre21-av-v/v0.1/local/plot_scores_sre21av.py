...
def plot_scores_condition(
    ...
    k_sre21a_dev = TrialKey.load_txt(key_sre21a_dev)
    # k_sre21a_eval = TrialKey.load_txt(key_sre21a_eval)
    k_sre21a_eval = TrialNdx.load_txt(key_sre21a_eval)
    ...
    k_sre21av_dev = TrialKey.load_txt(key_sre21av_dev)
    # k_sre21av_eval = TrialKey.load_txt(key_sre21av_eval)
    k_sre21av_eval = TrialNdx.load_txt(key_sre21av_eval)
    ...
    plt.grid(True)
    plt.legend()
    plt.savefig(f"{output_path}/hist_vid0.png")
    ...
    plt.grid(True)
    plt.legend()
    plt.savefig(f"{output_path}/hist_vid.png")
    plt.clf()
