...
def prepare_sre21av_dev_visual(corpus_dir, output_path, target_fs, verbose):
    config_logger(verbose)
    logging.info("Preparing corpus %s -> %s", corpus_dir, output_path)
    corpus_dir = Path(corpus_dir)
    vid_dir = corpus_dir / "data" / "audio"
...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(description="Prepares SRE21 dev video part")
