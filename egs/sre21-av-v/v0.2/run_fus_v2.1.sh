...
system_names="pt-b1 pt-b2 pt-b3 pt-b4 pt-b1s pt-b2s pt-b3s pt-b4s mxnet-b1 mxnet-b2 mxnet-b3 mxnet-b4 mxnet-b1s mxnet-b2s mxnet-b3s mxnet-b4s"
...
# done
# exit
output_dir=exp/fusion/v2.1_ptrn${p_trn}_l2${fus_l2_reg}
