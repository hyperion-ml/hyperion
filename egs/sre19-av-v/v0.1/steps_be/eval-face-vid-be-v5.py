...
def eval_be(
    ...
    **kwargs
    ...
    # do diarization on enroll side
    logging.info("diarization on enroll side")
    x_ref = cluster_embeds_ahc(x_ref, thr_ahc)

    # do diarization on test side
    logging.info("diarization on test side")
    x_t = cluster_embeds_ahc(x_t, thr_ahc)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--thr-ahc", type=float, default=0.9)
    parser.add_argument(
