...
def vae(file_path):
    ...
    x = Input(shape=(x_dim,))
    h1 = Dense(h_dim, activation='relu', kernel_initializer=my_init, kernel_regularizer=l2(l2_reg))(x)
    ...
    z=Input(shape=(z_dim,))
    h1_dec = Dense(h_dim, activation='relu', kernel_initializer=my_init, kernel_regularizer=l2(l2_reg))(z)
