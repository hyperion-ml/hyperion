...
def plot_figs1(res_dirs1, legends, title_base, fig_base, fmt=['b','r','g','m','c','y'], clean_ref=0): 
    df = []
    ...
    Eval.plot_dcf_eer_vs_stat_v2(df, 'snr', fig_file, clean_ref=clean_ref, 
    ...
    Eval.plot_dcf_eer_vs_stat_v2(df, 'n_linf', fig_file, clean_ref=clean_ref, 
...
def plot_figs2(res_dirs1, legends, title_base, fig_base, fmt=['b','r','g','m','c','y'], clean_ref=0, colors=None): 
    df = []
    for i in range(len(res_dirs1)):
        file_path='%s/%s/%s' %(base_res_dir, res_dirs1[i], filenames[0])
        df_i = pd.read_csv(file_path, index_col=0)
...
if __name__ == "__main__":
    ...
    res_dirs2 = ['resnet34_zir_e256_arc0.3_do0_adam_lr0.05_b512.v2', 
    ...
    res_dirs1 = ['cosine_cwl2_conf0', 'cosine_cwl2_conf0_noabort', 'cosine_cwl2_conf0_lr0.001', 'cosine_cwl2_conf0_lr0.001_noabort',
                 'cosine_cwl2_conf0_lr0.001_noabort_it20', 'cosine_cwl2_conf0_lr0.001_noabort_it40', 'cosine_cwl2_conf0_lr0.001_noabort_it80',
                 'cosine_cwl2_conf0_lr0.001_it80']
    legends = ['default', 'lr=0.01 it10', 'lr=0.001 it10 abort early', 'lr=0.001 it10',  'lr=0.001 it20',  'lr=0.001 it40',  'lr=0.001 it80',  
    ...
    res_dirs1 = ['cosine_cwl2_conf0', 'cosine_cwl2_conf0_lr0.001_noabort',
                 'cosine_cwl2_conf0_lr0.001_noabort_it20', 'cosine_cwl2_conf0_lr0.001_noabort_it40', 'cosine_cwl2_conf0_lr0.001_noabort_it80',
                 'cosine_cwl2_conf0_lr0.001_it80']
    legends = ['default', 'lr=0.001 it10',  'lr=0.001 it20',  'lr=0.001 it40',  'lr=0.001 it80',  
               'lr=0.001 it80 abort early']
    fmt=['b', 'r','g','m','c','y']
    ...
    res_dirs0= 'resnet34_zir_e256_arc0.3_do0_adam_lr0.05_b512.v2'
    res_dirs1 = ['cosine_fgsm_eall', 'cosine_randfgsm_eall', 'cosine_iterfgsm_eall', 
                 'cosine_cwl2_conf0_lr0.001_noabort', 'cosine_cwsnr_conf0_lr0.001_noabort_it10', 
                 'cosine_cwrms_conf0_lr0.001_noabort_it10', 'cosine_cwrms_conf4_lr0.001_noabort_it10', 'cosine_cwl2_conf0_lr0.001_noabort_it40']
    res_dirs1 = [res_dirs0 + '/' + s for s in res_dirs1]
    fmt=['ob', 'vr','^g','>y','sm','pc', 'Pc', '*r', '+g', 'Dc', 'Hm']
    fmt=['ob', 'vr','^g','>y','sm','pc', 'P', '*', '+g', 'Dc', 'Hm']
    colors=['b', 'r','g','y','m','c', 'lime', 'orange', '+g', 'Dc', 'Hm']
    legends = ['FGSM', 'Rand-FGSM', 'Iter-FGSM', 'CW-L2 k=0', 'CW-SNR k=0',
               'CW-RMS k=0', 'CW-RMS k=4', 'CW-RMS k=0 it=40']
    legends = ['FGSM', 'Rand-FGSM', 'Iter-FGSM', 'CW-L2', 'CW-SNR',
               'CW-RMS', 'CW-RMS k=4', 'CW-RMS it=40']
    ...
    res_dirs0= 'resnet34_zir_e256_arc0.3_do0_adam_lr0.05_b512.v2'
    res_dirs1 = ['cosine_iterfgsm_eall', 
                 'cosine_cwl2_conf0_lr0.001_noabort', 'cosine_cwsnr_conf0_lr0.001_noabort_it10', 
                 'cosine_cwrms_conf0_lr0.001_noabort_it10', 'cosine_cwrms_conf4_lr0.001_noabort_it10', 'cosine_cwl2_conf0_lr0.001_noabort_it40']
    res_dirs1 = [res_dirs0 + '/' + s for s in res_dirs1]
    fmt=['ob', 'vr','^g','>y','sm','pc', 'Pc', '*r', '+g', 'Dc', 'Hm']
    fmt=['ob', 'vr','^g','>y','sm','pc', 'P', '*', '+g', 'Dc', 'Hm']
    colors=['b', 'r','g','y','m','c', 'lime', 'orange', '+g', 'Dc', 'Hm']
    legends = ['Iter-FGSM', 'CW-L2', 'CW-SNR',
               'CW-RMS', 'CW-RMS k=4', 'CW-RMS it=40']
    ...
    res_dirs1 = ['cosine_iterfgsm_eall', 'cosine_iterfgsm_eall_randsmooth0.001', 'cosine_iterfgsm_eall_randsmooth0.01'] 
    legends = ['no-def', '$\sigma=32$',  '$\sigma=327$']  
    fmt=['b', 'r','g','m','c','y']
    
    res_dirs2 = [res_dirs0 + '/' + s for s in res_dirs1]

    plot_figs1(res_dirs2, legends, 'IterFGSM RandSmooth', 'iterfgsm_randsmooth', fmt=fmt)
    plot_figs2(res_dirs2, legends, 'IterFGSM RandSmooth', 'iterfgsm_randsmooth2', fmt=fmt)
    plot_figs2(res_dirs2, None, 'IterFGSM RandSmooth', 'iterfgsm_randsmoothnoleg2', fmt=fmt)
    ...
    fig_names = ['fgsm', 'randfgsm', 'iterfgsm', 'cwl2_conf0', 'cwl2_conf1', 'cwlinf_conf0', 'cwlinf_conf1']
    legends = ['ResNet34 (white-box)', 'ThinResNet34', 'ResETDNN']
    fmt=['b','r','g','m','c','y']
    for i in range(len(names)):
        res_dirs2 = [res_dirs1[i], 'transfer.lresnet34_zir_e256_arc0.3_do0_adam_lr0.05_b512.v2/' + res_dirs1[i],
                     'transfer.resetdnn_nl5ld512_e256_arcs30m0.3_do0.1_adam_lr0.05_b512_amp.v2/' + res_dirs1[i]]
        res_dirs2 = [res_dirs0 + '/' + s for s in res_dirs2]
        plot_figs1(res_dirs2, legends, names[i] + ' black-box', fig_names[i] + '_bbox', fmt=fmt)
        plot_figs2(res_dirs2, legends, names[i] + ' black-box', fig_names[i] + '_bbox2', fmt=fmt)
