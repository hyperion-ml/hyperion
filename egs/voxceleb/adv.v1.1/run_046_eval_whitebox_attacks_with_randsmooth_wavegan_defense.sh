...
if [ $stage -le 5 ];then
	...
	do
		...
		do
		    ...
		    steps_adv/eval_cosine_scoring_from_adv_test_wav_wavegan.sh --cmd "$eval_cmd" $eval_args --nj 100 \
			--feat-config $feat_config  \
...
if [ $stage -le 6 ];then
	...
	do
		...
		do
		    ...
		    steps_adv/eval_cosine_scoring_from_adv_test_wav_wavegan.sh --cmd "$eval_cmd -tc 15" $eval_args --nj 100 \
			--feat-config $feat_config  \
