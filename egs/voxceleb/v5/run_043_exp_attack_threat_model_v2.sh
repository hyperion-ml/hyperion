...
list_dir=data/exp_attack_threat_model_v2
list_test_attack_type_dir=data/exp_attack_type_v1
list_test_threat_model_dir=data/exp_attack_threat_model_v1
...
sign_nnet_dir=exp/sign_nnets/$nnet_name/exp_attack_threat_model_v2
sign_dir=exp/signatures/$nnet_name/exp_attack_threat_model_v2
logits_dir=exp/logits/$nnet_name/exp_attack_threat_model_v2
nnet_num_epochs=20
...
if [ $stage -le 2 ]; then
    ...
    mkdir -p $list_test_attack_type_dir/test
    cp $list_test_attack_type_dir/test_wav.scp $list_test_attack_type_dir/test/wav.scp
    nj=100
    steps_xvec/extract_xvectors_from_wav.sh \
	--cmd "$xvec_cmd --mem 6G" --nj $nj ${xvec_args} --use-bin-vad false \
	--feat-config $feat_config \
	$sign_nnet $list_test_attack_type_dir/test \
	$sign_dir/test
fi
