...
# Adapted from run_022_attack_type_classif_allknown.sh to use Denoiser for obtained the adversarial noise
...
sign_nnet_reldir=$spknet_name"_preprocess_denoiser_gan"/$sign_nnet_name/$attack_type_split_tag
sign_nnet_dir=exp/sign_nnets/$sign_nnet_reldir
sign_nnet_reldir_sign_with_denoiser=$spknet_name"_preprocess_denoiser_gan_with_denoiser"/$sign_nnet_name/$attack_type_split_tag
