...
# We train on attacks with SNR >=20 dB and test on attacks with SNR<20dB
...
sk_attack_type_split_tag="exp_attack_type_someknown_trnge20dB_testlt20dB"
sk_snr_split_tag="exp_attack_snr_someknown_trnge20dB_testlt20dB"
sk_threat_model_split_tag="exp_attack_threat_model_trnge20dB_testlt20dB"

# Experiment labels for attack verification with same attacks known and some unknown
attack_type_verif_split_tag="exp_attack_type_verif_trnge20dB_testlt20dB"
snr_verif_split_tag="exp_attack_snr_verif_trnge20dB_testlt20dB"
threat_model_verif_split_tag="exp_attack_threat_model_verif_trnge20dB_testlt20dB"
...
novelty_split_tag="exp_attack_type_novelty_trnge20dB_testlt20dB"
