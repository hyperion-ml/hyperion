# LSpineNet49 x-vector with 128 endpoint channels, with mixed precision training
...
nnet_name=${feat_type}_${nnet_type}_e${embed_dim}_arcs${s}m${margin}_do${dropout}_adam_lr${lr}_b${eff_batch_size}_amp_relu.v1
nnet_num_epochs=70
