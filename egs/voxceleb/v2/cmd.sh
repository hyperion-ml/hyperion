...
else # c2[3457] in clsp grid have 2080 gpus & there are 2 4 3 3 respectively
    export train_cmd="queue.pl --mem 4G -l hostname=\"[bc][01]*\" -V"
    export cuda_cmd="queue.pl --mem 20G -l hostname=\"c[012]*\" -V" # c04 seems to have some error, and c06 seems to be very slow
    #export cuda_eval_cmd="$train_cmd"
    export cuda_eval_cmd="queue.pl --mem 4G -l hostname='!c08*&!c23*&!c24*&!c25*&!c27*&c[012]*' -V"
fi
