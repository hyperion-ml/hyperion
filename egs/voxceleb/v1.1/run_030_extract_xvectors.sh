#!/bin/bash
# Copyright
#                2021   Johns Hopkins University (Author: Jaejin Cho)
...
state_dict_key=model_state_dict # which state dict to use from pre-trained model between student (model_state_dict) and teacher (model_teacher_state_dict for dinossl). This can be overwritten by ". $config_file" below
