...
#batch_size_1gpu=128 # cuda oom
batch_size_1gpu=64
eff_batch_size=256 # effective batch size. Not used in dinossl at the moment. In dinossl, actual eff_batch_size is batch_size_1gpu * ngpu and lr is changing depending on the effective batch size
ipe=$nnet_num_augs
min_chunk=2
max_chunk=2
lr=0.05
...
opt_opt="--optim.opt-type adam --optim.lr $lr --optim.beta1 0.9 --optim.beta2 0.95 --optim.weight-decay 1e-5 --optim.amsgrad --use-amp --optim.dinossl_style True"
...
nnet_num_epochs=70
nnet_dir=exp/xvector_nnets/${nnet_name}_dinossl_keep_classif_net # expdir (outdir)
nnet=$nnet_dir/model_ep0070.pth

# dinossl related: dataset/dataloader, model/loss
dinossl=true
dinossl_fclikeimage=true
## dino-head
