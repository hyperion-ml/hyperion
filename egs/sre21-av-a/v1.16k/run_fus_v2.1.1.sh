...
be31=pca0.45_rmu100000_rs100000_splday150_adapt1_wmu0.75_wb0.5_ww0.25_adapt2_wmu0.25_wb0.25_ww0.25_v3
be31v=pca0.85_rmu100_rs100000_splday150_adapt1_wmu0.5_wb0.25_ww0.25_adapt2_wmu0.75_wb0.25_ww0.25_v3

system_names="res2nets8-16k-chatt-b21 tseres2nets4-16k-chatt-b21 ecapa-16k-chatt-b21 res2nets4-16k-vox-b21 res2net8s-8k-chatt-b21 ecapa-8k-chatt-b21" 
...
exp/scores/fbank80_stmn_res2net50w26s4_e256_arcs30m0.3_do0_adam_lr0.05_b512_amp.v1.voxcelebcat.ft_10_15_arcm0.5_sgdcos_lr0.01_b128_amp.v1/$be21/plda_cal_v1 \
...
# done
# exit
output_dir=exp/fusion/v2.1_fus_pfus${p_trn}_l2${fus_l2_reg}_pcal${p_cal}_l2${cal_l2_reg}
