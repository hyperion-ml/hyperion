...
def train_be(
    ...
    **kwargs,
    ...
    elbo = plda.fit(x, class_ids, epochs=epochs, ml_md=ml_md, md_epochs=md_epochs)
    del x, class_ids
...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(
        description="Train PCA+LNorm+PLDA Back-end adapted to chinese speakers"
    )
    ...
    parser.add_argument("--w-mu", type=float, default=0.5)
