...
system_names="res2nets8-16k-chatt-b21 tseres2nets4-16k-chatt-b21 ecapa-16k-chatt-b21 res2net8s-8k-chatt-b21 ecapa-8k-chatt-b21 tseres2nets4-16k-chatt-b31 res2nets4-16k-vox-b31v res2net50-16k-bwe"
...
# done
# exit
output_dir=exp/fusion/v2.3.0_fus_pfus${p_fus}_l2${fus_l2_reg}_pcal${p_cal}_l2${cal_l2_reg}
