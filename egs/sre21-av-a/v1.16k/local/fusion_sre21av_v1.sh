...
ndxs=(sre21_audio_dev_test sre21_audio-visual_dev_test sre21_audio_eval_test sre21_audio-visual_eval_test $superset sre16_eval40_yue_test)
scores=(sre21_audio_dev sre21_audio-visual_dev sre21_audio_eval sre21_audio-visual_eval sre_cts_superset_dev sre16_eval40_yue)
n_ndx=${#ndxs[*]}
declare -a scores_in
for((i=0;i<$n_ndx;i++))
do
