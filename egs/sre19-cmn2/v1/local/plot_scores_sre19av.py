...
def gauss_map_adapt(mu,sigma,mu0,sigma0,N,r_mu,r_s2):
    ...
    s2_map = alpha_s2*s2+(1-alpha_s2)*s02 + alpha_s2*(1-alpha_mu)*(mu-mu0)**2
    return mu_map, np.sqrt(s2_map)


def plot_scores_sre18(
        key_sitw_core, scores_sitw_core,
        key_sitw_core_multi, scores_sitw_core_multi,
        key_sre18_eval, scores_sre18_eval,
        key_sre19_dev, scores_sre19_dev,
        key_sre19_eval, scores_sre19_eval,
        key_janus_dev, scores_janus_dev,
        key_janus_eval, scores_janus_eval,
        name,
        output_path):
    ...
    tar_sitw_core_multi, non_sitw_core_multi = scr_sitw_core_multi.get_tar_non(k_sitw_core_multi)
    ...
    plt.hist(tar_sitw_core, 80, histtype='step', density=True, color='b',
             linestyle='solid', linewidth=1.5, label='SITW eval core-core')
    plt.hist(non_sitw_core, 1000, histtype='step', density=True, color='b',
             linestyle='solid', linewidth=1.5)
    plt.hist(tar_sitw_core_multi, 80, histtype='step', density=True, color='r',
             linestyle='solid', linewidth=1.5, label='SITW eval core-multi')
    plt.hist(non_sitw_core_multi, 1000, histtype='step', density=True, color='r',
             linestyle='solid', linewidth=1.5)
    plt.hist(tar_sre18_eval, 15, histtype='step', density=True, color='g',
             linestyle='solid', linewidth=1.5, label='SRE18 eval VAST')
    plt.hist(non_sre18_eval, 200, histtype='step', density=True, color='g',
             linestyle='solid', linewidth=1.5)
    plt.hist(tar_sre19_dev, 5, histtype='step', density=True, color='c',
             linestyle='solid', linewidth=1.5, label='SRE19 dev AV')
    plt.hist(non_sre19_dev, 100, histtype='step', density=True, color='c',
             linestyle='solid', linewidth=1.5)
    plt.hist(tar_janus_dev, 10, histtype='step', density=True, color='y',
             linestyle='solid', linewidth=1.5, label='JANUS dev CORE')
    plt.hist(non_janus_dev, 200, histtype='step', density=True, color='y',
             linestyle='solid', linewidth=1.5)
    plt.hist(tar_janus_eval, 30, histtype='step', density=True, color='m',
             linestyle='solid', linewidth=1.5, label='JANUS eval CORE')
    plt.hist(non_janus_eval, 500, histtype='step', density=True, color='m',
             linestyle='solid', linewidth=1.5)
    ...
    plt.hist(non_sre19_eval, 200, histtype='step', density=True, color='k',
             linestyle='solid', linewidth=1.5, label='SRE19 eval AV')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--key-sitw-core-multi', dest='key_sitw_core_multi', required=True)
    parser.add_argument('--scores-sitw-core-multi', dest='scores_sitw_core_multi', required=True)
