...
dir2=ft_eaffine_rege_w_1000_6000_sgdcos_lr0.01_b128_amp.v2_ep10
...
do
    ...
    do
	wj=${w[$j]}
	table_file1=${table_file}_w${wj}_be$ii.csv
	d=$dir0/${be[$i]}/$be2
	d2=$dir0/${be[$i]}/$be20
	if [ ! -d $d ];then
	    d=$d2
	...
	d=$dir0.$dir1.$dir2/${be[$i]}/$be2
	d2=$dir0.$dir1.$dir2/${be[$i]}/$be20
	if [ ! -d $d ];then
	    d=$d2
	fi
