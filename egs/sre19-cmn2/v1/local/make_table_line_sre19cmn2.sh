...
if [ "$print_header" == "true" ];then
    ...
    dbs1=("SRE18 Eval40" "SRE19-Prog" "SRE19-Eval")
...
res_file=$sre18_dir/sre18_eval40_cmn2_results
...
res_file=$sre18_dir/sre19_eval_cmn2_results
awk  '/PROG-CMN2/{ printf "%.2f,%.3f,%.3f,", $2,$3,$4}' $res_file
    
if [ "$all_conds" == "true" ];then 
    for cond in $conds
    do
	awk  '/PROG-CMN2/ { printf "%.2f,%.3f,%.3f,", $2,$3,$4}' ${res_file}_$cond
    done
fi

awk  '/EVAL-CMN2/{ printf "%.2f,%.3f,%.3f,", $2,$3,$4}' $res_file
    
if [ "$all_conds" == "true" ];then 
    for cond in $conds
    do
	awk  '/EVAL-CMN2/ { printf "%.2f,%.3f,%.3f,", $2,$3,$4}' ${res_file}_$cond
    done
fi
