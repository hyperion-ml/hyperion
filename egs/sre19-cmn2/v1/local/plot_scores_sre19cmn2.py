...
def plot_scores_sre18(
        key_sre18_dev, scores_sre18_dev,
    ...
    plt.hist(tar_sre18_dev, 100, histtype='step', density=True, color='b',
             linestyle='solid', linewidth=1.5, label='SRE18 dev cmn2')
    plt.hist(non_sre18_dev, 1000, histtype='step', density=True, color='b',
             linestyle='solid', linewidth=1.5)
    plt.hist(tar_sre18_eval, 100, histtype='step', density=True, color='r',
             linestyle='solid', linewidth=1.5, label='SRE18 eval cmn2')
    plt.hist(non_sre18_eval, 1000, histtype='step', density=True, color='r',
             linestyle='solid', linewidth=1.5)
    ...
    #          linestyle='solid', linewidth=1.5, label='SRE18 eval cmn2')
    plt.hist(non_sre19_eval, 1000, histtype='step', density=True, color='g',
             linestyle='solid', linewidth=1.5, label='SRE19 eval cmn2')
