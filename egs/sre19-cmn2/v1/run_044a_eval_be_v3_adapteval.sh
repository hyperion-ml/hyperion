...
plda_tel_label=${plda_tel_type}y${plda_tel_y_dim}_adapt_v3eval_coral_mu${coral_mu}T${coral_T}_a1_mu${w_mu1}B${w_B1}W${w_W1}_a2_M${num_spks}_mu${w_mu2}B${w_B2}W${w_W2}
...
if [ $stage -le 1 ]; then
	...
	--w_coral_mu $coral_mu --w_coral_T $coral_T \
    	...
    	data/$plda_tel_data \
	$xvector_dir/sre18_train_eval_cmn2/xvector.scp \
	data/sre18_train_eval_cmn2 \
