...
# This script trains F-TDNN with layer-width=725
...
data=data/train
nnet_dir=exp/xvector_nnet_3b/
egs_dir=exp/xvector_nnet_3b/egs
...
if [ $stage -le 7 ]; then
  ...
  relu-batchnorm-layer name=tdnn5 $opts dim=725 input=Append(tdnn5l, tdnn3l)
  ...
  relu-batchnorm-layer name=tdnn9 $opts input=Append(0,tdnn8l,tdnn6l,tdnn4l) dim=725
