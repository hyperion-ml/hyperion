...
#   linear-component name=tdnn2l dim=150 $linear_opts input=Append(-2,0)
#   relu-batchnorm-layer name=tdnn2 $opts input=Append(0,2) dim=600
#   linear-component name=tdnn3l dim=150 $linear_opts
#   relu-batchnorm-layer name=tdnn3 $opts dim=600
#   linear-component name=tdnn4l dim=150 $linear_opts input=Append(-3,0)
#   relu-batchnorm-layer name=tdnn4 $opts input=Append(0,3) dim=600
#   linear-component name=tdnn5l dim=150 $linear_opts
#   relu-batchnorm-layer name=tdnn5 $opts dim=600 input=Append(tdnn5l, tdnn3l)
#   linear-component name=tdnn6l dim=150 $linear_opts input=Append(-3,0)
#   relu-batchnorm-layer name=tdnn6 $opts input=Append(0,3) dim=600
#   linear-component name=tdnn7l dim=150 $linear_opts input=Append(-3,0)
#   relu-batchnorm-layer name=tdnn7 $opts input=Append(0,3,tdnn6l,tdnn4l,tdnn2l) dim=600
#   linear-component name=tdnn8l dim=150 $linear_opts input=Append(-3,0)
#   relu-batchnorm-layer name=tdnn8 $opts input=Append(0,3) dim=600
#   linear-component name=tdnn9l dim=150 $linear_opts 
#   relu-batchnorm-layer name=tdnn9 $opts input=Append(0,tdnn8l,tdnn6l,tdnn4l) dim=600
#   relu-batchnorm-layer name=tdnn10 $opts dim=1500
...
#   echo "$min_chunk_size" > $nnet_dir/min_chunk_size
    ...
    cp $init_nnet_dir/$init_nnet_file $nnet_dir/configs/ref.raw
    cp $init_nnet_dir/$init_nnet_file $nnet_dir/0.raw
fi
