...
data=data/train
nnet_dir=exp/xvector_nnet_4b/
egs_dir=exp/xvector_nnet_4b/egs
...
if [ $stage -le 7 ]; then
  ...
  linear-component name=tdnn2l dim=215 $linear_opts input=Append(-2,0)
  relu-batchnorm-layer name=tdnn2 $opts input=Append(0,2) dim=850
  linear-component name=tdnn3l dim=215 $linear_opts
  relu-batchnorm-layer name=tdnn3 $opts dim=850
  linear-component name=tdnn4l dim=215 $linear_opts input=Append(-3,0)
  relu-batchnorm-layer name=tdnn4 $opts input=Append(0,3) dim=850
  linear-component name=tdnn5l dim=215 $linear_opts
  relu-batchnorm-layer name=tdnn5 $opts dim=850 input=Append(0, tdnn3l)
  linear-component name=tdnn6l dim=215 $linear_opts input=Append(-3,0)
  relu-batchnorm-layer name=tdnn6 $opts input=Append(0,3) dim=850
  linear-component name=tdnn7l dim=215 $linear_opts 
  relu-batchnorm-layer name=tdnn7 $opts input=Append(0,tdnn6l,tdnn4l,tdnn2l) dim=850
  linear-component name=tdnn8l dim=215 $linear_opts input=Append(-3,0)
  relu-batchnorm-layer name=tdnn8 $opts input=Append(0,3) dim=850
  linear-component name=tdnn9l dim=215 $linear_opts 
  relu-batchnorm-layer name=tdnn9 $opts input=Append(0,tdnn7l,tdnn5l,tdnn3l) dim=850
  linear-component name=tdnn10l dim=215 $linear_opts input=Append(-3,0)
  relu-batchnorm-layer name=tdnn10 $opts input=Append(0,3) dim=850
  linear-component name=tdnn11l dim=215 $linear_opts 
  relu-batchnorm-layer name=tdnn11 $opts input=Append(0,tdnn10l,tdnn8l,tdnn6l) dim=850
  linear-component name=tdnn12l dim=215 $linear_opts input=Append(-3,0)
  relu-batchnorm-layer name=tdnn12 $opts input=Append(0,3) dim=850
  linear-component name=tdnn13l dim=215 $linear_opts 
  relu-batchnorm-layer name=tdnn13 $opts input=Append(0,tdnn11l,tdnn9l,tdnn7l) dim=850
  linear-component name=tdnn14l dim=215 $linear_opts input=Append(-3,0)
  relu-batchnorm-layer name=tdnn14 $opts input=Append(0,3) dim=850
  linear-component name=tdnn15l dim=215 $linear_opts 
  relu-batchnorm-layer name=tdnn15 $opts input=Append(0,tdnn14l,tdnn12l,tdnn10l) dim=850
  linear-component name=tdnn16l dim=215 $linear_opts input=Append(-3,0)
  relu-batchnorm-layer name=tdnn16 $opts input=Append(0,3) dim=850
  linear-component name=tdnn17l dim=215 $linear_opts 
  relu-batchnorm-layer name=tdnn17 $opts input=Append(0,tdnn15l,tdnn13l,tdnn11l) dim=850
  linear-component name=tdnn18l dim=215 $linear_opts input=Append(-3,0)
  relu-batchnorm-layer name=tdnn18 $opts input=Append(0,3) dim=850
  linear-component name=tdnn19l dim=215 $linear_opts 
  relu-batchnorm-layer name=tdnn19 $opts input=Append(0,tdnn18l,tdnn16l,tdnn14l) dim=850
  relu-batchnorm-layer name=tdnn20 $opts dim=2000
...
EOF
  ...
  echo "output-node name=output input=tdnn21.affine" > $nnet_dir/extract.config
