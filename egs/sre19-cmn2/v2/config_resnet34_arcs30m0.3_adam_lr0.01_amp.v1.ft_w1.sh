...
ft2_nnet_name=${ft_nnet_name}.ft_eaffine_rege_w${reg_weigth_embed}_${ft_min_chunk}_${ft_max_chunk}_sgdcos_lr${ft2_lr}_b${ft2_eff_batch_size}_amp.v2
...
ft3_nnet_name=${ft2_nnet_name}.ft_reg_wenc${reg_weight_enc}_we${reg_weigth_embed}_${ft_min_chunk}_${ft_max_chunk}_sgdcos_lr${ft3_lr}_b${ft3_eff_batch_size}_amp.v2
