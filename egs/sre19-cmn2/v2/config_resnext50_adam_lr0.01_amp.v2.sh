...
nnet_type=resnext50_32x4d
batch_size_1gpu=12
eff_batch_size=480 # effective batch size
min_chunk=400
max_chunk=400
ipe=1
lr=0.01
...
nnet_name=resnext50_32x4d_zir_e${embed_dim}_arc${margin}_do${dropout}_adam_lr${lr}_b${eff_batch_size}_amp.v2
nnet_num_epochs=200
num_augs=4
