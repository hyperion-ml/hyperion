...
resnet_opt="--in-channels 1 --in-kernel-size 3 --in-stride 1 --no-maxpool --zero-init-residual --loss-type cos-softmax"
...
nnet_name=resnet34_zir_e${embed_dim}_ams${s}m${margin}_do${dropout}_adam_lr${lr}_b${eff_batch_size}_amp.v2
nnet_num_epochs=200
num_augs=4
