...
def main(net_type, batch_size, test_batch_size, exp_path,
         epochs, num_gpus, log_interval, resume, cifar_vers, **kwargs):
    ...
    trainer = TorchTrainer(model, optimizer, loss, epochs, exp_path, 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--net-type', default='resnet34', metavar='N',
    ...
    parser.add_argument('--cifar-vers', default=10, type=int, choices=[10, 100], help='CIFAR version')
