...
def create_net2(t_dim, y_dim, h_dim, num_comp, p, my_init, act,
    ...
    net2 = FFNetV1(num_layers, t_dim, h_dim, num_comp*y_dim, 'softmax', act, use_batchnorm=True,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num-comp', dest='num_comp', default=64, type=int)
