...
z_mean = TimeDistributed(Dense(z_dim, init=my_init, W_regularizer=l2(l2_reg)))(h2_z)
z_logvar = TimeDistributed(Dense(z_dim, init=my_init, W_regularizer=l2(l2_reg)))(h2_z)
...
plt.title('Q(y)')
plt.show()
plt.savefig('tied_vae_qyqzgy_qy_val.pdf')
