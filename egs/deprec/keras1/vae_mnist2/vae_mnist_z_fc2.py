...
h3 = Dense(latent_dim, init=my_init, W_regularizer=l2(l2_reg))(h2)
#z_logvar = Dense(latent_dim, init=my_init, W_regularizer=l2(l2_reg))(h2)
h4_layer = MultConstCovStdPrior(latent_dim)
z_mean, z_logvar, z_chol = h4_layer(h3)
#z_chol = TiledConstTriu(latent_dim, diag_val=1)(h2)

encoder=Model(x,[z_mean, z_logvar, z_chol])
...
# train VAE
vae=VAE(encoder, decoder, px_cond_form='bernoulli', qz_form='normal')
vae.build()
