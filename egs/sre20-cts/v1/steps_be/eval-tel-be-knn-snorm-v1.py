...
def eval_plda_e(x_e, x_t, back_end_dir, enroll_id,
                x_coh, preproc_basename, plda_basename,
                plda_type, pool_method, coh_nbest):
...
def eval_plda(iv_file, ndx_file, enroll_file, test_file,
              ...
              back_end_dir, preproc_basename, plda_basename,
              score_file, plda_type, pool_method, **kwargs):
    ...
    vr = VR(coh_iv_file, coh_list, None)
    x_coh = vr.read()
    ...
    for i in range(len(enroll)):
        ...
        mask_i = ids_e == i
        x_e_i = x_e[mask_i]
        scores_i = eval_plda_e(x_e_i, x_t, back_end_dir, enroll_i, x_coh,
                               preproc_basename, plda_basename,
                               plda_type, pool_method, coh_nbest)
        scores[i] = scores_i
...
if __name__ == "__main__":
    ...
    parser.add_argument('--plda-type', default='splda',
