...
aug_opt="--train-aug-cfg conf/reverb_noise_aug2.yaml --val-aug-cfg conf/reverb_noise_aug2.yaml"
...
ft2_nnet_name=${ft_nnet_name}.ft2_${ft2_min_chunk}_${ft2_max_chunk}_arcm${ft2_margin}_sgdcos_lr${ft2_lr}_b${ft2_eff_batch_size}_amp.v2.2
