...
aug_opt="--train-aug-cfg conf/reverb_noise_aug1.yaml --val-aug-cfg conf/reverb_noise_aug1.yaml"
...
# xvector full net finetuning with out-of-domain 2
ft2_batch_size_1gpu=32
ft2_eff_batch_size=256 # effective batch size
ft2_min_chunk=4
ft2_max_chunk=8
ft2_ipe=1
ft2_lr=0.01
ft2_nnet_num_epochs=45
ft2_nnet_num_epochs=100
ft2_margin=0.3
ft2_margin_warmup=3
...
ft2_nnet_name=${ft_nnet_name}.ft2_${ft2_min_chunk}_${ft2_max_chunk}_arcm${ft2_margin}_sgdcos_lr${ft2_lr}_b${ft2_eff_batch_size}_amp.v2.1
ft2_nnet_dir=exp/xvector_nnets/$ft2_nnet_name
ft2_nnet=$ft2_nnet_dir/model_ep0045.pth
