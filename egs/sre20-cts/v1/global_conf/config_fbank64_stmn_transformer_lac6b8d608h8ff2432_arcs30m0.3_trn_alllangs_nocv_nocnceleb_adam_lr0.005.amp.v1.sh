...
lrs_opt="--lrched.lrsch-type exp_lr --lrched.decay-rate 0.5 --lrched.decay-steps 12000 --lrched.hold-steps 40000 --lrched.min-lr 1e-5 --lrched.warmup-steps 10000 --lrched.update-lr-on-opt-step"
