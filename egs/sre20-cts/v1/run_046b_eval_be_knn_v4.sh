...
be_name=pca${pca_var_r}_knn${knn1}-${knn2}_lda${lda_dim}_${plda_label}_${plda_data}_v4_adapt_mu${w_mu}B${w_B}W${w_W}
...
if [ $stage -le 1 ]; then
	...
	steps_be/train_tel_be_knn_v4.sh --cmd "$train_cmd" --nj 40 --knn1 $knn1 --knn2 $knn2 --pca-var-r $pca_var_r \
    					--lda-dim $lda_dim \
    					--plda-type $plda_type \
