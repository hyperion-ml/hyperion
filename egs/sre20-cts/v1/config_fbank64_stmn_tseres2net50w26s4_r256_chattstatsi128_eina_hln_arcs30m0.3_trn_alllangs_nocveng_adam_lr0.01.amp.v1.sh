...
lrs_opt="--lrsch-lrsch-type exp_lr --lrsch-decay-rate 0.5 --lrsch-decay-steps 15000 --lrsch-hold-steps 60000 --lrsch-min-lr 1e-5 --lrsch-warmup-steps 2000 --lrsch-update-lr-on-opt-step"
