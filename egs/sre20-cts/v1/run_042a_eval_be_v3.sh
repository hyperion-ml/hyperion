...
#                
# Apache 2.0.
# Back-end LDA(All)+LN(All)-Adapted(NonEng) + PLDA(All)-Adapted(NonEng)
...
be_name=lda${lda_dim}_${plda_label}_${plda_data}_v3_adapt_mu${w_mu}B${w_B}W${w_W}_${plda_adapt_data}
