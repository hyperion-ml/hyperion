...
system_names="resnet34eng_ll1 resnet34eng_ll2 resnet34einaallnocvcn-knn tb8allnocvcn-knn effnetb4-knn saurabh1"
...
output_dir=exp/fusion/v1.22_${fus_set}_ptrn${p_trn}_l2${fus_l2_reg}
