...
system_names="resnet34einaallnocvcn-knn tb8allnocvcn-knn effnetb4-knn res2net50-knn resnet34bmha64-knn"
...
output_dir=exp/fusion/v1.21_${fus_set}_ptrn${p_trn}_l2${fus_l2_reg}
