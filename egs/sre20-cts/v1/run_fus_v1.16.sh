...
system_names="resnet34einaallnocvcn-knn tb8allnocvcn-knn effnetb4-knn effnetb4einaallnocvcn-knn"
system_dirs="exp/scores/fbank64_stmn_resnet34_eina_hln_e256_arcs30m0.3_do0_adam_lr0.01_b512_amp.v1.alllangs_nocv_nocnceleb.ft_10_60_arcm0.3_sgdcos_lr0.05_b128_amp.v2/$be2 \
...
exp/scores/fbank64_stmn_efficientnet-b4_is1_mbs1122121_ser4_fixsh_eina_hln_e256_arcs30m0.3_do0_adam_lr0.01_b512_amp.v1.alllangs_nocv_nocnceleb.ft_10_10_arcm0.3_sgdcos_lr0.05_b128_amp.v2/$be2"

output_dir=exp/fusion/v1.16_${fus_set}_ptrn${p_trn}_l2${fus_l2_reg}
