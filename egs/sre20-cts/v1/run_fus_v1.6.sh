...
be2=knn300_lda150_splday125_realtel_alllangs/plda_cal_v2sre16-yue

system_names="resnet34eng_ll1 resnet34allnocvcn resnet34einaallnocvcn resnet34einaallnocvcn-knn300 resnet34einaallnocvcn-ft3  tb8allnocvcn"
...
exp/scores/fbank64_stmn_resnet34_eina_hln_e256_arcs30m0.3_do0_adam_lr0.01_b512_amp.v1.alllangs_nocv_nocnceleb.ft_10_60_arcm0.3_sgdcos_lr0.05_b128_amp.v2.ft_eaffine_rege_w0.1_10_60_sgdcos_lr0.01_b128_amp.v2.realtel.ft_reg_wenc0.1_we0.1_10_30_sgdcos_lr0.01_b128_amp.v2/$be1 \
...
output_dir=exp/fusion/v1.6_${fus_set}_ptrn${p_trn}_l2${fus_l2_reg}
