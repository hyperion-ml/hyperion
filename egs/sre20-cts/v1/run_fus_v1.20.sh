...
system_names="resnet34eng_ll2 resnet34einaallnocvcn-knn tb8allnocvcn-knn effnetb4-knn res2net50-knn resnet34bmha64-knn"
...
output_dir=exp/fusion/v1.20_${fus_set}_ptrn${p_trn}_l2${fus_l2_reg}
