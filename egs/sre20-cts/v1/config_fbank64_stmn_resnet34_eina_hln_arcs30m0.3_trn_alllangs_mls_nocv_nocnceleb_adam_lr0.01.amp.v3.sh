...
# x-vector training 
nnet_data=alllangs_mls_nocv_nocnceleb
nnet_num_augs=4
...
nnet_name=${feat_type}_${nnet_type}_eina_hln_e${embed_dim}_arcs${s}m${margin}_do${dropout}_adam_lr${lr}_b${eff_batch_size}_amp.v1.$nnet_data
nnet_num_epochs=50
...
ft_nnet_name=${nnet_name}.ft_${ft_min_chunk}_${ft_max_chunk}_arcm${ft_margin}_sgdcos_lr${ft_lr}_b${ft_eff_batch_size}_amp.v3
ft_nnet_dir=exp/xvector_nnets/$ft_nnet_name
ft_nnet=$ft_nnet_dir/model_ep0045.pth
#ft_nnet=$ft_nnet_dir/model_ep0093.pth
...
ft2_batch_size_1gpu=32
ft2_eff_batch_size=128 # effective batch size
ft2_ipe=1
ft2_lr=0.01
ft2_lr=0.05
ft2_nnet_num_epochs=30
ft2_margin_warmup=3
...
ft2_nnet_name=${ft_nnet_name}.ft_eaffine_${ft2_min_chunk}_${ft2_max_chunk}_sgdcos_lr${ft2_lr}_b${ft2_eff_batch_size}_amp.v2.labunlab #$nnet_adapt_data
ft2_nnet_dir=exp/xvector_nnets/$ft2_nnet_name
ft2_nnet=$ft2_nnet_dir/model_ep0030.pth
