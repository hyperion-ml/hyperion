...
system_names="resnet34eng_ll1 resnet34eng_ll2 resnet34einaallnocvcn-knn tb8allnocvcn-knn"
...
output_dir=exp/fusion/v1.12_${fus_set}_ptrn${p_trn}_l2${fus_l2_reg}
