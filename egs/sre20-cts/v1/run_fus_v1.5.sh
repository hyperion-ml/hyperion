...
system_names="resnet34allnocvcn resnet34einaallnocvcn tb8allnocvcn"
system_dirs="exp/scores/fbank64_stmn_resnet34_e256_arcs30m0.3_do0_adam_lr0.01_b512_amp.v1.alllangs_nocv_nocnceleb.ft_10_60_arcm0.3_sgdcos_lr0.05_b128_amp.v2/$be1 \
...
output_dir=exp/fusion/v1.5_${fus_set}_ptrn${p_trn}_l2${fus_l2_reg}
