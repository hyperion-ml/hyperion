...
if (@ARGV != 3) {
  print STDERR "Usage: $0 <path-to-call-my-net-training-data> <fs>  <path-to-output>\n";
  print STDERR "e.g. $0 /export/corpora/SRE/LDC2016E46_SRE16_Call_My_Net_Training_Data 8 data/\n";
  exit(1);
}
