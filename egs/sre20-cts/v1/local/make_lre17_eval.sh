...
if [ $# != 3 ];then
    echo "Usage: $0 <lre17-eval-path> <fs 8/16> <output-path>"
    exit 1
fi
...
wav_path=$input_path/data/eval
key=$input_path/docs/lre17_eval_segments.key
...
do
    ...
    echo "Preparing LRE17 eval $lang"
