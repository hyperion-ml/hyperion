...
be2=pca0.975_knn800-200_lda150_splday125_realtel_alllangs_v3_adapt_mu1B0.5W0.5/plda_cal_v2sre16-yue

system_names="resnet34eng_ll1 resnet34allnocvcn resnet34allnocvcn-knn resnet34einaallnocvcn resnet34einaallnocvcn-knn tseresnet34allnocvcn-knn tb8allnocvcn tb8allnocvcn-knn"
...
output_dir=exp/fusion/v1.7_${fus_set}_ptrn${p_trn}_l2${fus_l2_reg}
